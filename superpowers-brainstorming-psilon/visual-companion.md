...
> Resolve every `scripts/...` command relative to the directory containing this guide. This preserves the upstream companion without assuming a plugin-root checkout path.
