...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    Resolve ordinary engineering choices from the brief, repository, and established patterns. Ask only when missing intent or authority would materially change the result; raise consequential concerns before starting work.
    ...
    **Testing:**
    ...
    - Commits created (short SHA + subject), or the exact uncommitted diff range when commits are not authorized
